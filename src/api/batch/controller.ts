...
export class batchController {
  ...
  public sendTourRem = async (
    ...
    logger.info("Router-----send Tour Remainder");
    try {
      const decodedToken ={
  ...
  public sendCarRem = async (
    ...
    logger.info("Router-----send car Remainder");
    try {
      const decodedToken ={
        id:request.plugins.token.id
      }
  ...
  public sendCustomizeTourRem = async (
    ...
    logger.info("Router-----send Customize Tour Remainder");
    try {
      const decodedToken ={
        id:request.plugins.token.id
      }
  ...
  public sendParkingRem = async (
    ...
    logger.info("Router-----send car parking Remainder");
    try {
      const decodedToken ={
        id:request.plugins.token.id
      }
