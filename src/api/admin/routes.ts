  ...
  public async register(server: any): Promise<any> {
    return new Promise((resolve) => {
      ...
      server.route([
        ...
        {
          method: "POST",
          path: "/api/v1/adminRoutes/updateEmployeeProfile",
          config: {
            pre: [{ method: validateToken, assign: "token" }],
            handler: controller.updateEmployeeProfile,
            validate: validate.updateEmployeeProfile,
            description: "update employee",
            tags: ["api", "Users"],
            auth: false,
          },
        ...
        {
          method: "POST",
          path: "/api/v1/adminRoutes/deleteUsers",
          config: {
            pre: [{ method: validateToken, assign: "token" }],
            handler: controller.deleteUsers,
            // validate: validate.deleteUsers,
        ...
        {
          method: "GET",
          path: "/api/v1/adminRoutes/employeeProfile",
          config: {
            pre: [{ method: validateToken, assign: "token" }],
            handler: controller.employeeProfile,
            // validate: validate.employeeProfile,
