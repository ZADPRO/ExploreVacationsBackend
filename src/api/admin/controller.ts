...
export class adminController {
  ...
  public listParkingBookings = async (
    request: any,
    response: Hapi.ResponseToolkit
  ): Promise<any> => {
    logger.info("Router-----listParkingBookings");
    try {
      const decodedToken ={
        id:request.plugins.token.id
      }
  ...
  public deleteCarBookings = async (
    request: any,
    response: Hapi.ResponseToolkit
  ): Promise<any> => {
    logger.info("Router-----deleteCarBookings");
    try {
      const decodedToken ={
        id:request.plugins.token.id
      }
  ...
  public deleteTourBookings = async (
    request: any,
    response: Hapi.ResponseToolkit
  ): Promise<any> => {
    logger.info("Router-----deleteTourBookings");
    try {
      const decodedToken ={
        id:request.plugins.token.id
      }
  ...
  public deleteCustomizeTourBookings = async (
    request: any,
    response: Hapi.ResponseToolkit
  ): Promise<any> => {
    logger.info("Router-----deleteCustomizeTourBookings");
    try {
      const decodedToken ={
        id:request.plugins.token.id
      }
  ...
  public deleteCarParkingBookings = async (
    request: any,
    response: Hapi.ResponseToolkit
  ): Promise<any> => {
    logger.info("Router-----deleteCarParkingBookings");
    try {
      const decodedToken ={
        id:request.plugins.token.id
      }
